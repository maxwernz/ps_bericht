...
% Hier anpassen 
\newcommand{\autor}{Wiesche Wolf}
\newcommand{\matrikelnummer}{2605000}
\newcommand{\fachsemester}{5} % im wie vielten Semester waren Sie?
\newcommand{\studiengang}{Medizintechnik}
%\newcommand{\studiengang}{Technische Informatik}
%\newcommand{\studiengang}{Informationstechnik}
\newcommand{\firma}{ACME Inc.}
\newcommand{\standort}{Mannheim}
\newcommand{\abteilung}{Forschung und Entwicklung}
\newcommand{\betreuer}{Jans Futter}
\newcommand{\pbeginn}{2.3.2022}
\newcommand{\pende}{26.8.2022}
